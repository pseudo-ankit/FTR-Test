...
public class HarborDTO {
	...
	/*
	 * if new terminal is added, opCode="ADD"
	 * if existing terminal is removed, opCode="DEL"
	 * if existing terminal is updated where available_capacity becomes 0, opCode="DEL"
	 * */
	...
	public static HarborEntity createEntity(HarborDTO harborDTO) {
		HarborEntity harborEntity = new HarborEntity();
		harborEntity.setCountry(harborDTO.getCountry());
		harborEntity.setAvailableHarborLocations(harborDTO.getAvailableHarborLocations());
		return harborEntity;
	}
}
